...
<%--                                            <input type="hidden" name="id" value="${product.getId()}">--%>
                                            <div class="form-group">
                                                ...
                                                <input type="name" class="form-control" name = "name" id="exampleInputName1" required="required" placeholder="Name" value="${product.getName()}"/>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="description" class="form-control" name="description" required="required" id="exampleInputDescription1" placeholder="Description" value="${product.getDescription()}"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPrice1">Price</label>
                                                <%--                        <input value="${product.getPrice()}" type="price" class="form-control" id="exampleInputPrice1" placeholder="Price">--%>
                                                <input type="price" class="form-control" name="price" required="required" id="exampleInputPrice1" placeholder="Price" value="${product.getPrice()}"/>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="createAt" required="required" id="exampleInputUpdateAt1" placeholder="UpdateAt" value="${product.getCreateAt()}"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputQuantity1">Quantity</label>

                                                <input type="quantity" class="form-control" name="quantity" required="required" id="exampleInputQuantity1" placeholder="Quantity" value="${product.getQuantity()}"/>
                                            </div>
                                            <div class="form-group">
